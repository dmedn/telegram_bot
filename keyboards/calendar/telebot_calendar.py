...
def check_month_day(num: str) -> str:
    numbers = list(range(1, 10))
    return '0' + num if num in numbers else num
...
class Calendar:
    ...
    def create_calendar(self, name: str = 'calendar_1', year: int = None, month: int = None) -> InlineKeyboardMarkup:
        ...
        keyboard.add(InlineKeyboardButton(self.__lang.months[month - 1] + " " + str(year), callback_data=data_months, ))
